...
from sklearn.metrics import auc, precision_score, classification_report, f1_score, confusion_matrix,ConfusionMatrixDisplay
...
def validate_FS(X,y,agent,caption="conf_mat", save=False):
    ...
    # ConfusionMatrixDisplay.from_estimator(model, X_test, y_test, values_format = 'd')
    # if save==True:
